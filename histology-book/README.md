...
| Terminology glossary | ✅ 520 entries × 12 columns (see `glossary/terminology-glossary.csv`) |
...
**Release gate status: `NOT READY FOR PUBLICATION`** — the book is incomplete (17 of 23 chapters).
