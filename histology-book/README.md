...
| Terminology glossary | ✅ 497 entries × 12 columns (see `glossary/terminology-glossary.csv`) |
...
**Release gate status: `NOT READY FOR PUBLICATION`** — the book is incomplete (16 of 23 chapters).
