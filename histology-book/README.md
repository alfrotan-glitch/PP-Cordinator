...
| Ch 11 — Nervous System & Neural Tissue | ⏳ Next |
...
| Terminology glossary | ✅ 328 entries × 12 columns (see `glossary/terminology-glossary.csv`) |
...
**Release gate status: `NOT READY FOR PUBLICATION`** — the book is incomplete (10 of 23 chapters).
