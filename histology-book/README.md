...
| Ch 16 — Organs Associated with the Digestive Tract | ⏳ Next |
...
| Terminology glossary | ✅ 478 entries × 12 columns (see `glossary/terminology-glossary.csv`) |
...
**Release gate status: `NOT READY FOR PUBLICATION`** — the book is incomplete (15 of 23 chapters).
