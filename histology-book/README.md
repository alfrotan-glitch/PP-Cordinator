...
| Ch 21 — Male Reproductive System | ⏳ Next |
| Ch 22 — Female Reproductive System | ⏳ Pending |
| Ch 23 — The Eye & Ear: Special Sense Organs | ⏳ Pending |
| Terminology glossary | ✅ 609 entries × 12 columns (see `glossary/terminology-glossary.csv`) |
...
**Release gate status: `NOT READY FOR PUBLICATION`** — the book is incomplete (20 of 23 chapters).
