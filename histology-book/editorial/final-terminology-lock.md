...
**Glossary:** 208 entries · 102 forbidden forms · 64 canonical replacements · 39 accepted variants ·
43 English-retained · 1 unresolved (آنتی‌ژن) · `[VERIFY TERMINOLOGY]` markers: 2 (both in the
...
**Self-test:** `SELFTEST: ALL PASS` — all 102 forbidden forms detected on injection; all 208 canonical
